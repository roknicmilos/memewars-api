...
class TestGoogleAuthLoginQuerySerializer(TestCase):
    ...
    def test_should_return_validation_error_for_invalid_query_params(self):
        ...
        url_query_params = {
            ...
            'login_failure_redirect_url': 'invalid-url'
        }
    ...
    def test_should_save_login_data_to_session_when_data_is_valid(self):
        ...
        self.assertEqual(
            login_in_progress_dict['login_success_redirect_url'],
            self.valid_data['login_success_redirect_url']
        )
        self.assertEqual(
            login_in_progress_dict['login_failure_redirect_url'],
            self.valid_data['login_failure_redirect_url']
        )
