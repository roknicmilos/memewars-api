...
class TestGoogleAuthCallbackAPIView(TestCase):
    ...
    def setUp(self) -> None:
        super().setUp()
        self._patch_get_user_from_google()
        self._patch_get_or_create_user()
        self._patch_build_login_success_url()
        self._patch_build_login_failure_url()

    def _patch_get_user_from_google(self) -> None:
        self.get_user_from_google_patcher = patch.object(google_auth, 'get_user')
        self.mock_get_user_from_google = self.get_user_from_google_patcher.start()
    ...
    def _patch_build_login_success_url(self) -> None:
        self.build_login_success_url_patcher = patch.object(google_auth, 'build_login_success_url')
    ...
    def _patch_build_login_failure_url(self) -> None:
        self.build_login_failure_url_patcher = patch.object(google_auth, 'build_login_failure_url')
    ...
    def tearDown(self) -> None:
        super().tearDown()
        self.get_user_from_google_patcher.stop()
